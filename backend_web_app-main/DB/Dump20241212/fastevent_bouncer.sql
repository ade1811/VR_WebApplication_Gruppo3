...
CREATE TABLE `bouncer` (
  `bouncerID` int NOT NULL AUTO_INCREMENT,
  `email` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`bouncerID`),
...
LOCK TABLES `bouncer` WRITE;
/*!40000 ALTER TABLE `bouncer` DISABLE KEYS */;
/*!40000 ALTER TABLE `bouncer` ENABLE KEYS */;
UNLOCK TABLES;

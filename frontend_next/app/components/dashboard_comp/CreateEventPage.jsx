...
export default function CreateEventPage() {
  ...
  useEffect(() => {
      localStorage.setItem("dashboard", "Crea Evento");
    })
          ...
          <div className="rounded-3xl relative isolate bg-gray-800 px-3 sm:px-8 mx-4 sm:mx-5 mt-24 sm:mt-32 sm:py-32 lg:px-8">
            ...
            <main className="relative z-10 pt-0 flex flex-col items-center px-4">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <p className="text-gray-500 font-light mt-5">In questa sezione dedicata puoi creare il tuo evento personalizzato. Il consiglio è di analizzare accuratamente le statistiche fornite dalla piattaforma e di consultare l'intelligenza artificiale prima di iniziare a creare l'evento e renderlo pubblico</p>
              </div>
              <form

  ...
  return (
    <div className="rounded-3xl relative isolate bg-gray-800 px-8 mx-4 sm:mx-20 mt-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="text-gray-500 font-light mt-5">In questa sezione puoi inserire i vari pacchetti di acquisto dei biglietti che verranno presentati al pubblico. Puoi decidere il prezzo di ogni pacchetto che vuoi associare all'evento. Analizza bene prima di salvare il pricing poichè una volta salvati i pacchetti non possono essere modificati</p>
      </div>

...
export default function Dashboard() {
  const [currentPage, setCurrentPage] = useState(localStorage.getItem("dashboard") || "Dashboard");
      ...
      <aside
        ...
        <nav className="mt-4">
          ...
          <ul className="mt-6">
            ...
            <li
              className="p-2 rounded-md flex items-center cursor-pointer hover:bg-gray-700"
              onClick={() => {setCurrentPage("Consulente AI")
                setIsSidebarOpen(false)
              }}>
              <SupportIcon className="w-5 h-5" />
              <span className="ml-2 font-medium text-lg">Consulente AI</span>
            </li>
            <li className="p-2 rounded-md flex items-center">
            </li>
          </ul>
